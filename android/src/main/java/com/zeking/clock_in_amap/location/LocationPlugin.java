package com.zeking.clock_in_amap.location;
...
import com.zeking.clock_in_amap.model.LocationModel;
...
//    }
    ...
    public LocationPlugin( FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
    ...
    public void init() {
        ...
        locationEventChannel = new EventChannel(flutterPluginBinding.getBinaryMessenger(), "cim/location_event");
        ...
        mlocationClient = new AMapLocationClient(flutterPluginBinding.getApplicationContext());
